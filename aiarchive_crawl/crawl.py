...
def main(args):
    ...
    with open("aiarchive_old.jsonl", "r", encoding="utf-8") as outfile:
        for line in outfile:
    ...
    with open(args.input_fpath, "r", encoding="utf-8") as infile, open(args.output_fpath, "w", encoding="utf-8") as outfile:
        for line in infile:
            data = json.loads(line.strip())
            post_url = data.get("postId")
