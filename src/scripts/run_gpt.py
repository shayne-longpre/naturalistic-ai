...
Only use information present or inferable from the input. Avoid hallucinations or unjustified assumptions."""
    ...
    TASK_DESCRIPTION = {
        "prompt": {
            ...
            "function_purpose": "Label all topics that are clearly present in the current user prompt, from the list of options below. This includes the topic of the task (e.g., creative writing would be 'Literature & Writing') and any other topics present in the content of that writing.",
