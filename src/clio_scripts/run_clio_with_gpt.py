...
async def run_gpt(args, batch_size=1, clio_annotation="is_occupational_task"):
    ...
    gpt_instance = gpt.GPT(model=args.model_id, base_url=args.api_base_url,
                           key_env=args.api_key_env, disable_token_counting=args.api_disable_token_counting)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_id", type=str, required=True, default=None, choices=[
                        "gpt-4o", "gpt-4o-mini", "gpt-4-turbo", "gpt-3.5-turbo", "o3-mini", "command-a-03-2025"])
    ...
    parser.add_argument("--api_disable_token_counting",
