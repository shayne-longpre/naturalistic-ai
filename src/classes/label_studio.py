...
def load_labelstudio_v2(
    ...
    """
    acceptable_fields = list(prompt_mappings.values()) + \
        list(response_mappings.values())
...
def split_labelstudio_files_by_conversation_id(
    ...
    print("Split annotations into two folders:")
...
def split_labelstudio_files_by_conversation_id_v2(
    ...
    print("Split records into two folders:")
